...
function questionAnswered(correct) {
  ...
  switch (question) {
    ...
    case 3:
      ...
      break;
    case 4:
      question4Options[0].classList.add('optionButtonCorrect');
      question4Options[1].classList.add('optionButtonWrong');
      question4Options[2].classList.add('optionButtonWrong');
      break;
    case 5:
      question5Options[0].classList.add('optionButtonWrong');
      question5Options[1].classList.add('optionButtonCorrect');
