  ...
  switch (question) {
    ...
    case 11:
      ...
      divQuizFinalizado.innerHTML = `
          ...
          <p style="font-size: 50px;">Parabéns ao grupo vencedor!</p>
...
function questionAnswered(correct) {
  ...
  switch (question) {
    ...
    case 2:
      ...
      break;
    case 3:
      question3Options[0].classList.add('optionButtonCorrect');
    ...
    case 5:
      ...
      question5Options[2].classList.add('optionButtonCorrect');
      break;
    case 6:
    ...
    case 8:
      ...
      question8Options[2].classList.add('optionButtonCorrect');
      break;
    case 9:
    ...
    case 10:
      ...
      question10Options[2].classList.add('optionButtonCorrect');
      break;
  }
